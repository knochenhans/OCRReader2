...
from OCRReader2.project.project import ExporterType, Project


class ExporterWidget(QWidget):
    def __init__(
        self, application_settings: SettingsManager, parent: Optional[QWidget] = None
    ):
    ...
    def set_project(self, project: Project) -> None:
        ...
        if self.project.settings_manager:
            self.set_export_path(self.project.settings_manager.get("export_path"))
    ...
    def generate_preview(self) -> None:
        ...
        try:
            ...
            if self.project.settings_manager:
                export_path: str = self.project.settings_manager.get("export_preview_path")
