...
from OCRReader2.page_editor.header_footer_item import HEADER_FOOTER_ITEM_TYPE

if TYPE_CHECKING:
    from OCRReader2.page_editor.page_editor_scene import PageEditorScene
...
class PageEditorController(QObject):
    ...
    def __init__(
        self,
        page: Page,
        scene: "PageEditorScene",
        application_settings: Optional[SettingsManager] = None,
        project_settings: Optional[SettingsManager] = None,
    ...
    def add_box(
        ...
        from OCRReader2.page_editor.commands.add_box_command import AddBoxCommand
