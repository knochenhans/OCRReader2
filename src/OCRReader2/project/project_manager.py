...
class ProjectManager:
    def __init__(self, project_folder: str) -> None:
        ...
        for folder in projects:
            ...
            if os.path.exists(project_file_path):
                ...
                project = Project.from_dict(project_data, project_path)
    ...
    def import_project(self, file_path: str) -> str:
        try:
            ...
            project = Project.from_dict(loaded_data, self.project_folder)
    ...
    def save_project_settings(self, project: Project) -> None:
        if project.settings_manager:
            project.settings_manager.save()

    def load_project_settings(self, project: Project) -> None:
        # TODO:
        project.settings_manager = SettingsManager("project_settings", project.folder, target=StorageTarget.DATA)
        project.settings_manager.load()
    ...
    def load_project_pages(
        ...
        project.set_ocr_processor(OCRProcessor(project.settings_manager))
    ...
    def new_project(
        ...
        name: str,
        description: str = "",
        default_settings_path: str = "src/data/",
        ...
        project.settings_manager = SettingsManager(
            "project_settings",
            project_path,
