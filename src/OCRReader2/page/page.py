...
from OCRReader2.page.image_preprocessor import ImagePreprocessor
from OCRReader2.page.ocr_box import BOX_TYPE_MAP, BoxType, OCRBox, TextBox
from OCRReader2.page.page_layout import PageLayout
...
class Page:
    def __init__(
        ...
        self.image: Optional[np.ndarray[Any, Any]] = None
    ...
    def recognize_ocr_boxes(
        ...
        image_boxes = [
            ...
            if not isinstance(box, TextBox) and box.type == BoxType.IGNORE
        ]
    ...
    def generate_page_export_data(
        self, project_settings: Optional[SettingsManager]
    ) -> Dict[str, Any]:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "Page":
        page_data = data["page"]
        image_path = page_data.get("image_path", None)
