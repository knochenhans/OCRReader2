...
class OCRBox:
    def __init__(
        ...
        self._callbacks: List[Callable[["OCRBox"], None]] = []
    ...
    @classmethod
    def from_dict(cls: Type["OCRBox"], data: Dict[str, Any]) -> "OCRBox":
    ...
    def load_ocr_results(
        ocr_result_data: Optional[Dict[str, Any]],
...
class TextBox(OCRBox):
    ...
    @classmethod
    def from_dict(cls: Type["TextBox"], data: Dict[str, Any]) -> "TextBox":
        position_data = data["position"]
        box = cls(
            x=position_data["x"],
            y=position_data["y"],
...
class ImageBox(OCRBox):
    ...
    @classmethod
    def from_dict(cls: Type["ImageBox"], data: Dict[str, Any]) -> "ImageBox":
...
class LineBox(OCRBox):
    ...
    @classmethod
    def from_dict(cls: Type["LineBox"], data: Dict[str, Any]) -> "LineBox":
        ocr_box = super().from_dict(data)
        box = cls(
            x=ocr_box.x,
            y=ocr_box.y,
...
class EquationBox(OCRBox):
    ...
    @classmethod
    def from_dict(cls: Type["EquationBox"], data: Dict[str, Any]) -> "EquationBox":
        ocr_box = super().from_dict(data)
        box = cls(
            x=ocr_box.x,
            y=ocr_box.y,
...
class TableBox(OCRBox):
    ...
    @classmethod
    def from_dict(cls: Type["TableBox"], data: Dict[str, Any]) -> "TableBox":
        ocr_box = super().from_dict(data)
        box = cls(
            x=ocr_box.x,
            y=ocr_box.y,
...
class NoiseBox(OCRBox):
    ...
    @classmethod
    def from_dict(cls: Type["NoiseBox"], data: Dict[str, Any]) -> "NoiseBox":
        ocr_box = super().from_dict(data)
        box = cls(
            x=ocr_box.x,
            y=ocr_box.y,
...
class CountBox(OCRBox):
    ...
    @classmethod
    def from_dict(cls: Type["CountBox"], data: Dict[str, Any]) -> "CountBox":
        ocr_box = super().from_dict(data)
        box = cls(
            x=ocr_box.x,
            y=ocr_box.y,
...
BOX_TYPE_MAP: Dict[str, Type[OCRBox]] = {
    "UNKNOWN": OCRBox,
