...
BOX_TYPE_COLOR_MAP = {
    BoxType.UNKNOWN: (0, 255, 0),  # RGB -> Green #00FF00
    BoxType.FLOWING_TEXT: (255, 0, 0),  # RGB -> Red #FF0000
    BoxType.HEADING_TEXT: (255, 0, 255),  # RGB -> Magenta #FF00FF
    ...
    BoxType.HEADING_IMAGE: (0, 128, 128),  # RGB -> Teal #008080
    BoxType.PULLOUT_IMAGE: (128, 0, 0),  # RGB -> Maroon #800000
