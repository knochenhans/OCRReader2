...
class ExporterPreview(ExporterHTMLBased):
    def __init__(self, output_path: str, filename: str, application_settings: Any) -> None:
    ...
    def export_project(self, project_export_data: Dict[str, Any]) -> None:
        ...
        try:
            ...
            for box_export_data in self.merge_boxes(boxes, lang):
                box_content, _ = self.get_box_content(box_export_data)
                html_content += box_content
